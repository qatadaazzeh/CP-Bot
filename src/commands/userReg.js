...
export default {
    ...
    async execute(interaction) {
        ...
        try {
            await newUser.save();
            return interaction.editReply(`You Have 5 Minutes to submit https://codeforces.com/contest/${whichProblem.contestId}/problem/${whichProblem.index} as Compilation error after this use \`/user-validate: handle\``);
        } catch (err) {
